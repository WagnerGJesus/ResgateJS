function start() {
  ...
  function movefundo() {
    ...
    ); /* converte para inteiro a posicao */
    $("#fundoGame").css(
      "background-position",
      esquerda - 1
    ); /* atualiza a posicao decrementando efeito parallax */
  ...
  function colisao() {
    ...
    if (colisao1.length > 0) {
      //decrementa Energia do Jogador
      energiaAtual--;
      inimigo1X = parseInt($("#inimigo1").css("left"));
      inimigo1Y = parseInt($("#inimigo1").css("top"));
      //desenha a explosao do Inimigo1
    ...
    //Fim da função Inimigo2 com o amigo
